...
const repeatMyParam = (event) => {
    //YOUR CODE HERE
    axios.get(`http://localhost:3000/repeat/'how ya derrin'`)
    .then(function(res) {
...
function request() {
    axios.get(`http://localhost:3000/query-test/?name=Jake`)
    .then(res => {
        console.log(res.data)
    })
}
